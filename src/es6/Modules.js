...
// 자바스크립트는 원래 HTML을 지원하기 위해 개발된 언어이기 때문에 html 문서내에서 <script></script>나 <script src = '파일경로'></script> 형태로
//다른 자바스크립트의 내용을 사용했음.
// 자바 스크립트가 발전하면서 자바스크립트를 단순히 웹에서만 사용하는 것이 아니게되어 외부 자바스크립트 내용을 사용하기 위한 방법이 여러가지로 개발됨
// ES6 버전부터 export, import를 지원함
// 자바스크립트 파일 각각을 모듈이라고 불림
// 각각의 모듈에는 각각의 export default가 존재한다
...
// html 문서내에서 import를 사용하고자 할 경우 <script type = "module">을 사용하여 해당 파일이 모듈을 사용한다는 것을 알려야 함.
// <script type = "module" src="파일경로"></script>

// export : 변수, 함수, 클래스를 다른 자바스크립트 파일에서 사용 할 수 있도록 설정
// 사용법 :
// export 함수명;
// export {함수명1, 함수명2, ...};
// export default 함수명;
...
// import 함수명 from 파일경로; // export defalut로 지정된 것을 불러옴
