...
// combined['key'] = 'value' 의 형태. 기존의 해쉬맵
...
// object 생성 시 키값을 설정하지 않으면 변수명이 키값으로 설정 된다. es5에선 무조건 값을 설정해 줘야 함. 위의 예시 참고. var obj = {x:x}
var obj = {x,y};
console.log(obj);
...
console.log('\n----- ES6 -----');
var list = [0,1];
// 대입 연산자 왼쪽에 [] 를 사용하여 그 안에 배열을 쓰듯이 변수명을 입력하면 대입 연산자 오른쪽의 데이터를 하나씩 꺼내어 대입 연산자 왼쪽의 변수명에 각각 저장 됨
...
// 대입 연산자 왼쪽에 {}을 사용하고 변수명을 입력하면, 대입 연산자 오른쪽의 object 타입의 키와 같은 변수명에 데이터를 저장
...
console.log(key1);
// 변수 값 받아 올 떄 key1 동일한 변수명에 값이 있어서 값만 가져오고, ...others는 나머지 key2: 'two' 다가져옴
console.log(others);